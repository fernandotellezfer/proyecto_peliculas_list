...
while opc!="7":
    ...
    match opc:
        ...
        case "2":
                funciones.borrarPantalla()
                peliculas.borrarPeliculas(pelis, conexionBD)
        case "3":
                funciones.borrarPantalla()
                peliculas.modificarPeliculas(pelis, conexionBD)
        case "4":
                funciones.borrarPantalla()
                peliculas.mostrarPeliculas(conexionBD)
        case "5":
                funciones.borrarPantalla()
                peliculas.buscarPeliculas(pelis, conexionBD)
        case "6":
                funciones.borrarPantalla()
                peliculas.limpiarPeliculas(pelis, conexionBD)
        case "7":
                funciones.borrarPantalla()
                funciones.terminar()
        case _:
